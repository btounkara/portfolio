...
export default function Experience({ value, delay, openModal }) {
    ...
    >
        <div className={`timeline-marker ${value.isWork === false ? 'is-info is-icon' : ''}`}>
            {
                value.isWork === false && <i className="fas fa-graduation-cap"></i>
            }
        </div>
        <div className="timeline-content">
            ...
            {
                value.isWork && <a className="button learn-more is-outlined is-light is-rounded inverted"
