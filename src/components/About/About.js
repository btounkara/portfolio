...
const LANGUAGES = ['Java', 'React', 'JavaScript (ES6)', 'Angular', 'XML', 'SQL', 'HTML5', 'CSS3'];
const TECHNOLOGIES = ['Java 11', 'Spring', 'React', 'React Native', 'Android', 'Angular', 'NodeJS', 'Webpack', 'Babel', 'Sass', 'Bulma', 'Android'];
